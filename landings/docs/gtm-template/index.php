...
<head>
    ...
    <title>Официальный шаблон Google Tag Manager – Botfaqtor code - BotFAQtor.ru</title>
    ...
    <meta property="og:url" content="http://botfaqtor-new/docs/gtm-template/" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Официальный шаблон Google Tag Manager – Botfaqtor code - BotFAQtor.ru" />
            ...
            <div class="inner">
                <div class="col-row">
                    <div class="col-2">
                        <div class="sidebar">
                            <ul>
                               <li><a href="instruc.php" class="instruc">Инструкция по добавлению шаблона на сайт</a></li>
                                <li class="active"><a href="index.php" class="docs">Документация</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-10">
                        ...
                        <div>
                            ...
                            <div style="display:flex; margin-top:40px;">
                                <img src="../landing/img/gtm.png" alt style="width:60px;height:60px;">
                                <h2 style="font-size: 36px; padding: 6px 0 40px 10px;">Официальный шаблон Google Tag
                                    Manager
                                    – Botfaqtor code</h2>
                            </div>
                            <span class="contact-span text-about-span">
                                <p>На этой странице находится официальная документация шаблона, созданного для удобного
                                    размещения обязательного кода Botfaqtor на сайт.</p>
                                <p style="font-weight: bold;">Страница шаблона в галерее GTM: <a
                                        href="https://tagmanager.google.com/gallery/#/owners/botfaqtor/templates/gtm_template"
                                        target="blink">https://tagmanager.google.com/gallery/#/owners/botfaqtor/templates/gtm_template</a>
                                </p>
                                <p style="font-weight: bold;">Страница шаблона на github: <a
                                        href="https://github.com/botfaqtor/gtm_template"
                                        target="blink">https://github.com/botfaqtor/gtm_template</a></p>

                                <h3 style="text-align:left">Входные данные:</h3>
                                <p>
                                    <i>- 'siteId'</i>
                                    Идентификатор сайта, который можно получить в личном кабинете Botfaqtor.
                                    Представляет
                                    собой положительное целое число. Обязательное поле.
                                </p>

                                <h3 style="text-align:left; border-top: 1px solid #dcdcdc;">Методы:</h3>
                                <p>
                                    <i>- 'injectScript(url, onSuccess, onFailure[, cacheToken])'</i>
                                    Добавляет на страницу тег скрипта для асинхронной загрузки предоставленного URL.
                                    Обратные вызовы имеют вид экземпляров функции, упакованных в осуществляющие вызовы
                                    функции JavaScript.
                                </p>

                                <p>
                                    <i>- 'generateRandom(min, max)'</i>
                                    Возвращает случайное целое число из заданного диапазона.
                                </p>

                                <p>
                                    <i>- 'encodeUriComponent(str)'</i>
                                    Возвращает закодированный унифицированный идентификатор ресурса (URI) с
                                    экранированными специальными символами. Возвращаемая строка представляет собой
                                    результат кодирования полученной строки в формат URI.
                                </p>

                                <h3 style="text-align:left; border-top: 1px solid #dcdcdc;">Разрешения:</h3>
                                <p>
                                    <i>- 'добавление скриптов на страницу'</i>
                                    Позволяет загрузить только скрипт сервиса Botfaqtor на сайт.
                                </p>

                                <h3 style="text-align:left; border-top: 1px solid #dcdcdc;">Необходимые триггеры:
                                </h3>
                                <p>
                                    <i>- 'All Pages'</i>
                                ...
                                <h3 style="text-align:left; border-top: 1px solid #dcdcdc;">Скриншоты:</h3>
                                <img src="screen-gtm.png" alt>
                            </span>
                        </div>
                    </div>
                </div>
